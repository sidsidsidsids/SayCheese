...
=== 회원 가입 시 이메일 인증 전송 API(잘못된 값이 들어왔을 시)
operation::EmailIntegrationTest/EmailTransportRegexFailTest[snippets='http-request,request-fields,http-response,response-fields']