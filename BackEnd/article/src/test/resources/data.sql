...
insert into frame(created_date, frame_specification, link, name, open_yn, type)
values (now(), 'HORIZONTAL', 'link17', '프레임 이름이에요7', 'Y', 'png'),
(now(), 'HORIZONTAL', 'link18', '프레임 이름이에요8', 'Y', 'png'),
(now(), 'HORIZONTAL', 'link19', '프레임 이름이에요9', 'Y', 'png'),
(now(), 'HORIZONTAL', 'link20', '프레임 이름이에요10', 'Y', 'png'),
(now(), 'HORIZONTAL', 'link21', '프레임 이름이에요11', 'Y', 'png'),
(now(), 'HORIZONTAL', 'link22', '프레임 이름이에요12', 'Y', 'png');
